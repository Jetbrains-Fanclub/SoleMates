...
public class SeriesNodesHandler {
  ...
  public SeriesNodesHandler(HashingService hashingService, BaseNodesHandler baseNodesHandler, IContentService contentService, ILogger<SeriesNodesHandler> logger) {
